...
" Set tmux tab name to name of document open
autocmd BufReadPost,FileReadPost,BufNewFile,BufEnter * call system("tmux rename-window " . expand("%:t") . "")
autocmd VimLeave * call system("tmux rename-window $(echo $SHELL | cut -d'/' -f4)"))
...
hi StatusLine ctermfg=3 ctermbg=NONE cterm=bold
